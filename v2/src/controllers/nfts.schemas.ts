...
export const nftSchema =
  "_id_, __token__, _edition, _supply, _floor, _ccy, _creator, _username, _asset, _type, _name, _description,	_city, _latitude, _longitude, _visibility, _maxLat, _minLat, _maxLon, _minLon, _date, _time, _timestamp";
