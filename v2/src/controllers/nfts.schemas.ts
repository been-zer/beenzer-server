...
export const nftSchema =
  "_id_, __token__, _supply, _creator, _username, _asset, _type, _naame, _description,	_city, _latitude, _longitude, _distance, _maxLat, _minLat, _maxLon, _minLon, _date, _time, _timestamp";
