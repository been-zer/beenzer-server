...
export const nftInit =
  "_id_ BIGINT NOT NULL, __token__ VARCHAR(255) NOT NULL, __edition__ INT NOT NULL, _supply INT, _floor FLOAT, _ccy VARCHAR(10), _creator VARCHAR(255), _username VARCHAR(255), _image VARCHAR(255), _asset VARCHAR(255), _type VARCHAR(25), _metadata VARCHAR(255), _name VARCHAR(255), _description VARCHAR(2048), _city VARCHAR(75), _latitude DOUBLE PRECISION, _longitude DOUBLE PRECISION,  _visibility VARCHAR(55), _maxLat DOUBLE PRECISION, _minLat DOUBLE PRECISION, _maxLon DOUBLE PRECISION, _minLon DOUBLE PRECISION, _date VARCHAR(22), _time VARCHAR(22), _timestamp BIGINT, PRIMARY KEY (__token__, __edition__)";
...
export const nftSchema =
  "_id_, __token__, __edition__, _supply, _floor, _ccy, _creator, _username, _image, _asset, _type, _metadata, _name, _description,	_city, _latitude, _longitude, _visibility, _maxLat, _minLat, _maxLon, _minLon, _date, _time, _timestamp";
