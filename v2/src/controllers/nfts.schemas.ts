...
export const editionInit =
  "__master__ VARCHAR(255), __token__ VARCHAR(255), __edition__ INT, _owner VARCHAR(255), _created_at BIGINT, _timestamp BIGINT, PRIMARY KEY (__master__, __token__, __edition__)";
...
export const editionSchema =
  "__master__, __token__, __edition__, _owner, _created_at, _timestamp";
