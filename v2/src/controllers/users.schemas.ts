...
export const userSchema = '__pubkey__ , _username_, _pfp, _name, _lastname, _description, _birthdate, _country, _flag, _phone, _email, _verified, _twitter, _instagram, _discord, _telegram, _youtube, _tiktok, _magiceden, _opensea, _created_at, _timestamp';
